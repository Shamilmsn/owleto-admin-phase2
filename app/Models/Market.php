...
class Market extends Model implements HasMedia
{
    ...
    public static $adminRules = [
        ...
        'paymetMethods' =>'required',
        'fields' => 'required',
        'order_request_commission_amount' => 'required',
        'categories' =>'required',
        'users' =>'required',
    ];
    ...
    {
        return $this->morphMany(config('medialibrary.media_model'), 'model')->where('collection_name', 'image');
    }
    ...
    {
        return $this->belongsToMany(\App\Models\Field::class, 'market_fields', 'market_id', 'field_id');
    }

    public function market_payment_methods()
    {
        return $this->belongsToMany(\App\Models\PaymentMethod::class, 'market_payment_methods');
    }
    public function market_categories()
    {
        return $this->belongsToMany(\App\Models\Category::class, 'market_categories', 'market_id', 'category_id');
    }

    public function mediaProfilePic()
    {
        return $this->belongsTo(\App\Models\Media::class, 'media_id_profile_pic');
    }

    public function mediaCoverPic()
    {
        return $this->belongsTo(\App\Models\Media::class, 'media_id_cover_pic');
    }
