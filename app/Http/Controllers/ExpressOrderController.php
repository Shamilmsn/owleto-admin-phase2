...
class ExpressOrderController extends Controller
{
     ...
     * @return Response
     */
    public function index(ExpressOrderDataTable $orderDataTable)
    {
        ...
        return $orderDataTable->render('express-orders.index', compact('orderStatus',
            'paymentMethods',
