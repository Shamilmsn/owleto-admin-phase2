...
<!-- Theme style -->
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.css" crossorigin="anonymous" referrerpolicy="no-referrer" />
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        <img src="{{auth()->user()->getFirstMediaUrl('avatar','icon')}}" class="brand-image mx-2 img-circle elevation-2" alt="User Image">
                         {!! auth()->user()->name !!}<i class="fa fa fa-angle-down"></i>
                    </a>
