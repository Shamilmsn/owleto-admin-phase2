<div class='btn-group btn-group-sm'>
    @can('package-order-details.edit')
        <a data-toggle="tooltip" data-placement="bottom"
           href="{{ route('package-order-details.edit', $packageOrder->id) }}" class='btn btn-link'>
    ...
    @if(!$packageOrder->driver_id && $packageOrder->order_status_id != \App\Models\OrderStatus::STATUS_CANCELED && !$packageOrder->canceled)
