    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                <li class="nav-item">
                    <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-list mr-2"></i>Vendor Locations</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
...
<script>
    ...
    var locations = [];
    var vendors = @json($vendorLocations);

    var centerLatitude = {{$centerLatitude}};
    var centerLongitude = {{$centerLongitude}};

    var arrayLength = vendors.length;

    for (var i = 0; i < arrayLength; i++) {
        locations.push(vendors[i]);
    }
