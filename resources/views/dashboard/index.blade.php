...
{{--            </div>--}}
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header no-border">
                        <div class="d-flex justify-content-between">
                            <h3 class="card-title">Sector Wise Earnings</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="d-flex">
...
{{--                                <span class="text-muted">{{trans('lang.dashboard_total_orders')}}</span>--}}
                        ...
                        <div class="position-relative mb-4">
                            <canvas id="field_chart" height="200"></canvas>
                        </div>
                        <div class="d-flex flex-row justify-content-end">
{{--                            <span class="mr-2"> <i class="fa fa-square text-primary"></i> {{trans('lang.dashboard_this_year')}} </span>--}}
                        </div>
...
@push('scripts')
    <script type="text/javascript">
        ...
        function newChart(chartNode,labels,data)
        {
            return new Chart(chartNode, {
                type: 'doughnut',
                data : {
        ...
        $(function () {
            ...
            var $fieldChart = $('#field_chart');

            renderChart($salesChart, {!! $data !!}, {!! $labels !!} );
            newChart($fieldChart,{!! $sectorLabels !!},{!!  $sectorValues !!});
        })
